  ...
  return (
    <div>
        ...
        <div className="relative px-4 py-4 w-full max-w-md h-full md:h-auto">
                    <div className="relative bg-neutral-800 opacity-95 rounded-lg shadow border-4 border-purple-700">
                        ...
                        <div className="p-6 text-center">
                            <div className="text-2xl font-semibold text-fuchsia-200">Stake Ether</div>
                            <div className="mt-6">
